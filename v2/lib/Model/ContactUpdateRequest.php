...
class ContactUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setPhone($phone)
    {
        ...
        if (($phone > 15)) {
            throw new \InvalidArgumentException('invalid value for $phone when calling ContactUpdateRequest., must be smaller than or equal to 15.');
        }
        if (($phone < 9)) {
            throw new \InvalidArgumentException('invalid value for $phone when calling ContactUpdateRequest., must be bigger than or equal to 9.');
        }
