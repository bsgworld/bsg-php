 ...
 */
class FiltercreatedatThisValueIsNotAValidDate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'filtercreatedatThisValueIsNotAValidDate';
