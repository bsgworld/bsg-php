 ...
 */
class DefaultThisValueShouldBeOfTypeBoolean implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'defaultThisValueShouldBeOfTypeBoolean';
