    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 200)) {
            throw new \InvalidArgumentException('invalid length for $title when calling Card., must be smaller than or equal to 200.');
        }
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $text when calling Card., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling Card., must be bigger than or equal to 1.');
        }
    ...
    public function setSuggestions($suggestions)
    {
        ...
        if ((count($suggestions) > 4)) {
            throw new \InvalidArgumentException('invalid value for $suggestions when calling Card., number of items must be less than or equal to 4.');
        }
