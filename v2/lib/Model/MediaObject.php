 ...
 */
class MediaObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MediaObject';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Used if link is not set
     *
     * @return self
     */
     ...
     * Sets link
     *
     * @param string|null $link Used if id is not set
     *
     * @return self
     */
     ...
     * Sets filename
     *
     * @param string|null $filename Describes the filename for the specific document. Use only with document media.     The extension of the filename will specify what format the document is displayed as in WhatsApp
     *
     * @return self
     */
