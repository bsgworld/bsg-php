...
/**
 * ViberOptions Class Doc Comment
 *
 * @category Class
 * @package  BSG\Api\V2
 * @author   OpenAPI Generator team
 ...
 */
class ViberOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ViberOptions';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['link_url']) && !preg_match("/%^((viber:\/\/[a-z0-9\\:\\?\\=\\.]{1,})|(https?:\/\/))%i/", $this->container['link_url'])) {
            $invalidProperties[] = "invalid value for 'link_url', must be conform to the pattern /%^((viber:\/\/[a-z0-9\\:\\?\\=\\.]{1,})|(https?:\/\/))%i/.";
        }
    ...
    public function setImageUrl($image_url)
    {
        ...
        if ((mb_strlen($image_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $image_url when calling ViberOptions., must be smaller than or equal to 255.');
        }
        if ((!preg_match("/^(http|https)://([A-Z0-9][A-Z0-9_-]*)(\\.[A-Z0-9][A-Z0-9_-]*)+(:(\\d+))?([-_/A-Z0-9?=&]*)?(\\.jpg|\\.png|\\.tiff|\\.jpeg|\\.gif|\\.bmp){1}$/iD", ObjectSerializer::toString($image_url)))) {
            throw new \InvalidArgumentException("invalid value for \$image_url when calling ViberOptions., must conform to the pattern /^(http|https)://([A-Z0-9][A-Z0-9_-]*)(\\.[A-Z0-9][A-Z0-9_-]*)+(:(\\d+))?([-_/A-Z0-9?=&]*)?(\\.jpg|\\.png|\\.tiff|\\.jpeg|\\.gif|\\.bmp){1}$/iD.");
        }
    ...
    public function setButtonCaption($button_caption)
    {
        ...
        if ((mb_strlen($button_caption) > 20)) {
            throw new \InvalidArgumentException('invalid length for $button_caption when calling ViberOptions., must be smaller than or equal to 20.');
        }
    ...
    public function setLinkUrl($link_url)
    {
        ...
        if ((mb_strlen($link_url) > 255)) {
            throw new \InvalidArgumentException('invalid length for $link_url when calling ViberOptions., must be smaller than or equal to 255.');
        }
        if ((!preg_match("/%^((viber:\/\/[a-z0-9\\:\\?\\=\\.]{1,})|(https?:\/\/))%i/", ObjectSerializer::toString($link_url)))) {
            throw new \InvalidArgumentException("invalid value for \$link_url when calling ViberOptions., must conform to the pattern /%^((viber:\/\/[a-z0-9\\:\\?\\=\\.]{1,})|(https?:\/\/))%i/.");
        }
