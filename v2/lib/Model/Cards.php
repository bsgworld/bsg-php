 ...
 */
class Cards implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cards';
    ...
    */
    ...
    public function setCards($cards)
    {
        ...
        if ((count($cards) > 10)) {
            throw new \InvalidArgumentException('invalid value for $cards when calling Cards., number of items must be less than or equal to 10.');
        }
        if ((count($cards) < 1)) {
            throw new \InvalidArgumentException('invalid length for $cards when calling Cards., number of items must be greater than or equal to 1.');
        }
