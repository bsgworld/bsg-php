...
| ------------- | ------------- | ------------- |
| [**b696e239f742e868841bd2173294ef8e()**](MessagesSMSApi.md#b696e239f742e868841bd2173294ef8e) | **GET** /api/messages | Find messages |


## `b696e239f742e868841bd2173294ef8e()`

```php
b696e239f742e868841bd2173294ef8e($page_offset, $page_limit, $sort, $way, $filter_id, $filter_campaign_id, $filter_reference_id, $filter_from, $filter_to): \BSG\\Api\\V2\Model\B696e239f742e868841bd2173294ef8e200Response
```
...
try {
    $result = $apiInstance->b696e239f742e868841bd2173294ef8e($page_offset, $page_limit, $sort, $way, $filter_id, $filter_campaign_id, $filter_reference_id, $filter_from, $filter_to);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessagesSMSApi->b696e239f742e868841bd2173294ef8e: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\BSG\\Api\\V2\Model\B696e239f742e868841bd2173294ef8e200Response**](../Model/B696e239f742e868841bd2173294ef8e200Response.md)
