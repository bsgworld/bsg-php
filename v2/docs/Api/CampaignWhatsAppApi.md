...
| ------------- | ------------- | ------------- |
| [**call34da90b5e9b23d2ba3752779bc3e2e18()**](CampaignWhatsAppApi.md#call34da90b5e9b23d2ba3752779bc3e2e18) | **POST** /api/campaigns/whatsapp/send |  |
...
```php
call34da90b5e9b23d2ba3752779bc3e2e18($send_whats_app_campaign): \BSG\\Api\\V2\Model\CampaignSchema
```
...
try {
    $result = $apiInstance->call34da90b5e9b23d2ba3752779bc3e2e18($send_whats_app_campaign);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CampaignWhatsAppApi->call34da90b5e9b23d2ba3752779bc3e2e18: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
whatsappSingle($whats_app_message): \BSG\\Api\\V2\Model\RcsSingle200Response
```
