 ...
 */
class SmsCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmsCreateResponse';
    ...
    */
    ...
    public function setTaskId($task_id)
    {
        ...
        if ((!preg_match("/^[0-9]+$/", ObjectSerializer::toString($task_id)))) {
            throw new \InvalidArgumentException("invalid value for \$task_id when calling SmsCreateResponse., must conform to the pattern /^[0-9]+$/.");
        }
    ...
    public function setTotalPrice($total_price)
    {
        ...
        if (($total_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_price when calling SmsCreateResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling SmsCreateResponse., must conform to the pattern /^[A-Z]{3}$/.");
        }
