...
/**
 * ViberCreateResponseResultInner Class Doc Comment
 *
 * @category Class
 * @package  BSG\\Api\\V1
 * @author   OpenAPI Generator team
 ...
 */
class ViberCreateResponseResultInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ViberCreateResponse_result_inner';
    ...
    */
     ...
     * Sets reference
     *
     * @param string|null $reference Message reference ID (if provided in request)
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string|null $id Internal message ID (when error = 0)
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param float|null $price Message price (when error = 0)
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency Price currency (when error = 0)
     *
     * @return self
     */
