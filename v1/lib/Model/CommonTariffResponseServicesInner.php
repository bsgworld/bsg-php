...
/**
 * CommonTariffResponseServicesInner Class Doc Comment
 *
 * @category Class
 ...
 */
class CommonTariffResponseServicesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CommonTariffResponse_services_inner';
    ...
    public const SERVICE_HLR = 'hlr';
    public const SERVICE_MNP = 'mnp';
    ...
    */
     ...
     * Sets service
     *
     * @param string|null $service Service type
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param string|null $price Price per unit with decimal precision
     *
     * @return self
     */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling CommonTariffResponseServicesInner., must conform to the pattern /^[A-Z]{3}$/.");
        }
