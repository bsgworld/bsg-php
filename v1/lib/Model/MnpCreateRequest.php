 ...
 */
class MnpCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MnpCreateRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('msisdns', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets msisdn
     *
     * @param string $msisdn Phone number in international format for MNP lookup
     *
     * @return self
     */
     ...
     * Sets reference
     *
     * @param string|null $reference Global reference ID for the entire batch
     *
     * @return self
     */
     ...
     * Sets tariff
     *
     * @param int|null $tariff Tariff code for pricing (optional, uses user default if not provided)
     *
     * @return self
     */
     ...
     * Sets callback_url
     *
     * @param string|null $callback_url URL for delivery reports (optional)
     *
     * @return self
     */
    ...
    {
        if (is_null($msisdns)) {
            throw new \InvalidArgumentException('non-nullable msisdns cannot be null');
        }
