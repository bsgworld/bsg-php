...
/**
 * SMSPriceCheckMultiplePhones Class Doc Comment
 *
 * @category Class
 * @package  BSG\\Api\\V1
 * @author   OpenAPI Generator team
 ...
 */
class SMSPriceCheckMultiplePhones implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SMS_Price_Check___Multiple_Phones';
    ...
    */
    ...
    public function setPhones($phones)
    {
        ...
        if ((count($phones) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $phones when calling SMSPriceCheckMultiplePhones., number of items must be less than or equal to 1000.');
        }
        if ((count($phones) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phones when calling SMSPriceCheckMultiplePhones., number of items must be greater than or equal to 1.');
        }
    ...
    public function setOriginator($originator)
    {
        ...
        if ((mb_strlen($originator) > 15)) {
            throw new \InvalidArgumentException('invalid length for $originator when calling SMSPriceCheckMultiplePhones., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($originator) < 3)) {
            throw new \InvalidArgumentException('invalid length for $originator when calling SMSPriceCheckMultiplePhones., must be bigger than or equal to 3.');
        }
    ...
    public function setBody($body)
    {
        ...
        if ((mb_strlen($body) > 765)) {
            throw new \InvalidArgumentException('invalid length for $body when calling SMSPriceCheckMultiplePhones., must be smaller than or equal to 765.');
        }
        if ((mb_strlen($body) < 1)) {
            throw new \InvalidArgumentException('invalid length for $body when calling SMSPriceCheckMultiplePhones., must be bigger than or equal to 1.');
        }
    ...
    public function setTariff($tariff)
    {
        ...
        if (($tariff > 999)) {
            throw new \InvalidArgumentException('invalid value for $tariff when calling SMSPriceCheckMultiplePhones., must be smaller than or equal to 999.');
        }
        if (($tariff < 1)) {
            throw new \InvalidArgumentException('invalid value for $tariff when calling SMSPriceCheckMultiplePhones., must be bigger than or equal to 1.');
        }
