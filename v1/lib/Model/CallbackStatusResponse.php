...
/**
 * CallbackStatusResponse Class Doc Comment
 *
 * @category Class
 * @description Status information for callback webhook
 * @package  BSG\Api\V1
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CallbackStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CallbackStatusResponse';
    ...
    */
     ...
     * Sets status
     *
     * @param string $status Current callback status
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url Registered webhook URL
     *
     * @return self
     */
     ...
     * Sets events
     *
     * @param string[]|null $events Subscribed event types
     *
     * @return self
     */
     ...
     * Sets last_success
     *
     * @param \DateTime|null $last_success Last successful callback delivery
     *
     * @return self
     */
     ...
     * Sets failure_count
     *
     * @param int|null $failure_count Number of consecutive failures
     *
     * @return self
     */
