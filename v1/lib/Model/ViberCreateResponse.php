 ...
 */
class ViberCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ViberCreateResponse';
    ...
    */
     ...
     * Sets total_price
     *
     * @param float|null $total_price Total price for all successfully created messages
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency Currency for total_price
     *
     * @return self
     */
