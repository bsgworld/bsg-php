...
/**
 * CallbackCreateResponseData Class Doc Comment
 *
 * @category Class
 * @package  BSG\\Api\\V1
 * @author   OpenAPI Generator team
 ...
 */
class CallbackCreateResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CallbackCreateResponse_data';
    ...
    */
     ...
     * Sets callback_id
     *
     * @param string|null $callback_id Unique callback identifier
     *
     * @return self
     */
