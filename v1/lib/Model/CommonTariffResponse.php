 ...
 */
class CommonTariffResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CommonTariffResponse';
    ...
    */
     ...
     * Sets tariff_name
     *
     * @param string|null $tariff_name Commercial name of the tariff plan
     *
     * @return self
     */
    public function setTariffName($tariff_name)
    {
        if (is_null($tariff_name)) {
            throw new \InvalidArgumentException('non-nullable tariff_name cannot be null');
        }
     ...
     * Sets tariff_code
     *
     * @param string|null $tariff_code Internal tariff code identifier
     *
     * @return self
     */
