...
/**
 * HlrCreateResponseResultInner Class Doc Comment
 *
 * @category Class
 * @package  BSG\\Api\\V1
 * @author   OpenAPI Generator team
 ...
 */
class HlrCreateResponseResultInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HlrCreateResponse_result_inner';
    ...
    */
     ...
     * Sets error
     *
     * @param int|null $error Error code (0 = success)
     *
     * @return self
     */
     ...
     * Sets tariff_code
     *
     * @param int|null $tariff_code Applied tariff code
     *
     * @return self
     */
