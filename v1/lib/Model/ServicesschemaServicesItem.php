...
/**
 * ServicesschemaServicesItem Class Doc Comment
 *
 * @category Class
 ...
 */
class ServicesschemaServicesItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServicesschemaServicesItem';
    ...
    */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling ServicesschemaServicesItem., must conform to the pattern /^[A-Z]{3}$/.");
        }
