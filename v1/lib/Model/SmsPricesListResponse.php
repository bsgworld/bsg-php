 ...
 */
class SmsPricesListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmsPricesListResponse';
    ...
    */
    ...
    public function setError($error)
    {
        ...
        if (($error < 0)) {
            throw new \InvalidArgumentException('invalid value for $error when calling SmsPricesListResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setErrorDescription($error_description)
    {
        ...
        if ((mb_strlen($error_description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $error_description when calling SmsPricesListResponse., must be smaller than or equal to 255.');
        }
