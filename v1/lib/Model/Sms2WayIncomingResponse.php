 ...
 */
class Sms2WayIncomingResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Sms2WayIncomingResponse';
    ...
    */
     ...
     * Sets error
     *
     * @param int $error Error code: 0 for success, 35 for inactive 2way SMS service
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int $total_count Total number of messages found
     *
     * @return self
     */
