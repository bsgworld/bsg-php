...
/**
 * SMSTaskResponse Class Doc Comment
 *
 * @category Class
 * @package  BSG\\Api\\V1
 * @author   OpenAPI Generator team
 ...
 */
class SMSTaskResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SMS_Task_Response';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[0-9]+$/", $this->container['task_id'])) {
            $invalidProperties[] = "invalid value for 'task_id', must be conform to the pattern /^[0-9]+$/.";
        }
     ...
     * Sets task_id
     *
     * @param string $task_id Task ID for bulk SMS operations
     *
     * @return self
     */
    public function setTaskId($task_id)
    {
        ...
        if ((!preg_match("/^[0-9]+$/", ObjectSerializer::toString($task_id)))) {
            throw new \InvalidArgumentException("invalid value for \$task_id when calling SMSTaskResponse., must conform to the pattern /^[0-9]+$/.");
        }
     ...
     * Sets total_price
     *
     * @param float $total_price Total price for all messages in task
     *
     * @return self
     */
    public function setTotalPrice($total_price)
    {
        ...
        if (($total_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_price when calling SMSTaskResponse., must be bigger than or equal to 0.');
        }
     ...
     * Sets currency
     *
     * @param string $currency Currency code for total price
     *
     * @return self
     */
    public function setCurrency($currency)
    {
        ...
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling SMSTaskResponse., must conform to the pattern /^[A-Z]{3}$/.");
        }
