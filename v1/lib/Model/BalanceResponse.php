...
class BalanceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets amount
     *
     * @param string|null $amount Current account balance
     *
     * @return self
     */
    ...
    public function setCurrency($currency)
    {
        ...
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling BalanceResponse., must conform to the pattern /^[A-Z]{3}$/.");
        }
     ...
     * Sets limit
     *
     * @param string|null $limit Credit limit for the account
     *
     * @return self
     */
