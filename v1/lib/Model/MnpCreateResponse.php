 ...
 */
class MnpCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MnpCreateResponse';
    ...
    */
     ...
     * Sets total_price
     *
     * @param float $total_price Total price for all MNP lookups in the request
     *
     * @return self
     */
    public function setTotalPrice($total_price)
    {
        ...
        if (($total_price < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_price when calling MnpCreateResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((!preg_match("/^[A-Z]{3}$/", ObjectSerializer::toString($currency)))) {
            throw new \InvalidArgumentException("invalid value for \$currency when calling MnpCreateResponse., must conform to the pattern /^[A-Z]{3}$/.");
        }
