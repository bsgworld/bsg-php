 ...
 */
class ViberPricesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ViberPricesRequest';
    ...
    */
    ...
    public function setMessages($messages)
    {
        ...
        if ((count($messages) < 1)) {
            throw new \InvalidArgumentException('invalid length for $messages when calling ViberPricesRequest., number of items must be greater than or equal to 1.');
        }
