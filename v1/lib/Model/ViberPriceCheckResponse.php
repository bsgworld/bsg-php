...
/**
 * ViberPriceCheckResponse Class Doc Comment
 *
 * @category Class
 * @description Response for Viber price check - returns total price without sending messages
 * @package  BSG\Api\V1
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ViberPriceCheckResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ViberPriceCheckResponse';
    ...
    */
     ...
     * Sets totalprice
     *
     * @param float|null $totalprice Total calculated price for all messages
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency Price currency (ISO 4217)
     *
     * @return self
     */
