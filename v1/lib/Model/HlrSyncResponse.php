 ...
 */
class HlrSyncResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HlrSyncResponse';
    ...
    */
     ...
     * Sets reference
     *
     * @param string|null $reference External reference ID (if provided)
     *
     * @return self
     */
