...
**phones** | [**\BSG\\Api\\V1\Model\PhoneNumbersInner1[]**](PhoneNumbersInner1.md) | Array of phone objects with individual message content. Each phone has its own originator and message text |
