...
**phones** | [**\BSG\\Api\\V1\Model\PhoneNumbersInner[]**](PhoneNumbersInner.md) | Array of phone objects (required for destination&#x3D;phones). Maximum 1000 recipients per request |
